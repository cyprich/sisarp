...
{
    private static readonly string[] MaleFirstNames = ["Ján", "Alexander", "Adam", "Juraj", "Štefan"];
    private static readonly string[] MaleLastNames = ["Nový", "Malý", "Veľký", "Chudý", "Vysoký", "Bohatý", "Krásny"];
    private static readonly string[] FemaleFirstNames = [ "Silvia", "Františka", "Michaela", "Barbora", "Eva" ];
    private static readonly string[] FemaleLastNames = ["Nová", "Malá", "Veľká", "Chudá", "Vysoká", "Bohatá", "Krásna"];
